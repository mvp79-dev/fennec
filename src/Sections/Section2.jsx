          ...
          <div className="two-content">
            <div className="two-content-left">
              <div className={`two-content-slide-left ${isVisibleOne ? 'visible' : ''}`} ref={oneRef} > 
                <h1 className="description white" >Enhance Customer experiences</h1>
              </div>
              <div className={`two-content-slide-left ${isVisibleTwo ? 'visible' : ''}`} ref={twoRef} > 
                <h1 className="description white" >Enhance Customer experiences</h1>
              </div>
              <div className={`two-content-slide-left ${isVisibleThree ? 'visible' : ''}`} ref={threeRef} > 
                <h1 className="description white" >Enhance Customer experiences</h1>
              </div>
            </div>
            ...
            <div className="two-content-right">
              ...
              <div className={`two-content-slide-right ${isVisibleSeven ? 'visible' : ''}`} ref={sevenRef} > 
                <h1 className="description white" >Enhance Customer experiences</h1>
              </div>
            </div>
          </div>
